...
import com.suitcore.feature.member.MemberView
...
class ChoosePresenter: BasePresenter<ChooseView>, CoroutineScope {

    @Inject
    lateinit var apiService: APIService
    private var mvpView: ChooseView? = null
...
//    }
    ...
    override fun attachView(view: ChooseView) {
        mvpView = view
